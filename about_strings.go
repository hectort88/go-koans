...
func aboutStrings() {
	...
	assert("smith" < "xyz")    // i suppose maybe this could be useful.. someday
	...
	assert(fmt.Sprintf("your balance: %d and %0.2f", 3, 4.5589) == "your balance: 3 and 4.55") // "the root of all evil" is actually a misquotation, by the way
}
